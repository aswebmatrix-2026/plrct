...
export const metadata = {
  ...
  description:
    'Read leadership messages from the Chairman, Director, and Principal of PLRCT, Ballabgarh, Faridabad — their vision, philosophy, and commitment to students.',
...
const jsonLd = {
  ...
  '@type': 'AboutPage',
  name: 'Leadership Messages — PLRCT',
