...
export const OVERVIEW_PILLARS = [
  {
    ...
    body: 'PLRCT sits in Ballabgarh, Faridabad, inside the Delhi NCR industrial corridor — a location chosen deliberately, not incidentally. Being minutes from one of North India\'s densest manufacturing and IT belts means the college\'s engineering, management, and pharmacy programs are built with working industry as a neighbor rather than a distant case study. AICTE-approved and PCI-recognized, PLRCT operates under a governance structure that reports academic outcomes, infrastructure standards, and faculty qualifications transparently to regulatory bodies each year.',
  },
  {
